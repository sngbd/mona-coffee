...
class AdminDeliveryOrderDetailScreen extends StatelessWidget {
  const AdminDeliveryOrderDetailScreen({super.key});
                    ...
                    Row(
                      children: [
                        Text(
                          'Customer name: ',
                          style: TextStyle(
                              fontWeight: FontWeight.w600, color: mDarkBrown),
                        ),
                        Text(
                          'Lorenzo',
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    // Payment Method moved inside the card
                    Row(
                      children: [
                        const Expanded(
                          child: Text(
